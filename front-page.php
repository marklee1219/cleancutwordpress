    ...
    <div class="container">
      <div class="col-md-12">
        <div class="showcase-content">
          ...
          <a href="<?php echo get_theme_mod('facebook_url', 'http://facebook.com'); ?>" class="btn btn-default btn-lg" target="_blank"><i class="fa fa-facebook fa-fw"></i>Facebook</a>
          <?php endif; ?>

          <?php if(get_theme_mod('twitter_url', 'http://twitter.com') != '') : ?>
          <a href="<?php echo get_theme_mod('twitter_url', 'http://twitter.com'); ?>" class="btn btn-default btn-lg" target="_blank"><i class="fa fa-twitter fa-fw"></i>Twitter</a>
          <?php endif; ?>

          <?php if(get_theme_mod('linkedin_url', 'http://linkedin.com') != '') : ?>
          <a href="<?php echo get_theme_mod('linkedin_url', 'http://linkedin.com'); ?>" class="btn btn-default btn-lg" target="_blank"><i class="fa fa-facebook fa-fw"></i> Linkedin</a>
          <?php endif; ?>
